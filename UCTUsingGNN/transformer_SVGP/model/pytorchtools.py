...
class EarlyStopping:
    ...
    def __call__(self, val_loss, model, epoch_i, gp, likelihood, dataset):
        ...
        if self.best_score is None:
            ...
            self.save_checkpoint(val_loss, model, epoch_i, gp, likelihood, dataset)
    ...
    def save_checkpoint(self, val_loss, model, epoch_i, gp, likelihood, dataset):
