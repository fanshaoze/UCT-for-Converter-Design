...
from analysis.graphUtils import indexed_graph_to_adjacency_matrix, adj_matrix_to_graph, graph_to_adjacency_matrix, \
    nodes_and_edges_to_adjacency_matrix, adj_matrix_to_edges


class TopoGraph(object):
    def __init__(self, node_list, adj_matrix=None, graph=None, edge_list=None, hint=None, new_repr=False):
