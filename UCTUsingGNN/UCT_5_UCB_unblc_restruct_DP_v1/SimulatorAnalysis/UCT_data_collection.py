...
def key_expression_dict(target_vout_min=-500, target_vout_max=500):
    data_json_file = json.load(open("./UCT_5_UCB_unblc_restruct_DP_v1/SimulatorAnalysis/database/data.json"))
    # data_json_file = json.load(open("./database/data.json"))
    # print(len(data_json_file))
    expression_json_file = json.load(open("./UCT_5_UCB_unblc_restruct_DP_v1/SimulatorAnalysis/database/expression.json"))
    ...
    simu_results = []
    with open("./UCT_5_UCB_unblc_restruct_DP_v1/SimulatorAnalysis/database/analytic.csv", "r") as csv_file:
    ...
    with open('./UCT_5_UCB_unblc_restruct_DP_v1/SimulatorAnalysis/database/analytic-expression.json', 'w') as f:
...
def get_one_device_list(graph, comp2port_mapping, port2comp_mapping, idx_2_port, port_2_idx, parent, component_pool,
    ...
    directory_path = './UCT_5_UCB_unblc_restruct_DP_v1/SimulatorAnalysis/components_data_random'
    target_folder = './UCT_5_UCB_unblc_restruct_DP_v1/SimulatorAnalysis/database'
...
def read_analytics_result():
    data_json_file = json.load(open("./UCT_5_UCB_unblc_restruct_DP_v1/SimulatorAnalysis/database/analytic-expression.json"))
    return data_json_file

def read_no_sweep_analytics_result():
    data_json_file = json.load(
        open("./UCT_5_UCB_unblc_restruct_DP_v1/SimulatorAnalysis/database/no-sweep-analytic-expression.json"))
...
def read_sim_result():
    data_json_file = json.load(open("./UCT_5_UCB_unblc_restruct_DP_v1/SimulatorAnalysis/database/key_sim_result.json"))
    return data_json_file

def read_no_sweep_sim_result():
    data_json_file = json.load(open("./UCT_5_UCB_unblc_restruct_DP_v1/SimulatorAnalysis/database/no-sweep-key-sim-result.json"))
    return data_json_file
...
def save_no_sweep_analytics_result(simu_results):
    with open('./UCT_5_UCB_unblc_restruct_DP_v1/SimulatorAnalysis/database/no-sweep-analytic-expression.json', 'w') as f:
        json.dump(simu_results, f)
    f.close()


def save_sim_result(simu_results):
    with open('./UCT_5_UCB_unblc_restruct_DP_v1/SimulatorAnalysis/database/key_sim_result.json', 'w') as f:
        json.dump(simu_results, f)
    f.close()
    
def save_no_sweep_sim_result(simu_results):
    with open('./UCT_5_UCB_unblc_restruct_DP_v1/SimulatorAnalysis/database/no-sweep-key-sim-result.json', 'w') as f:
        json.dump(simu_results, f)
    f.close()
