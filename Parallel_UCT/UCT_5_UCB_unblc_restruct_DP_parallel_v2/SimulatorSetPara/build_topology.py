...
def save_ngspice_file_with_parameters(netlist, path, parameters, ngspice_para):
...
def nets_to_ngspice_files(topologies, configs, n_components=4,
    ...
    for i in range(0, len(topologies)):
        ...
        list_of_node, list_of_edge, netlist, joint_list, list_of_node_2, list_of_edge_2 = \
            convert_to_netlist(graph, component_pool, port_pool, parent, comp2port_mapping)
        ...
        param_list, param_list_2 = save_ngspice_file_with_parameters(netlist, file_path, topologies[i].parameters, ngspice_para)
        data[name] = {
