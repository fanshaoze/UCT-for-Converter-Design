...
def nets_to_ngspice_files(topologies, configs, n_components=4,
    ...
    #TODO select the parameter 
    cap_paras = "10"  # or "10,20"
    ind_paras = "100"  # or ,"30,50"
    ...
    for i in range(0, len(topologies)):
        ...
        with open(directory_path + '/'+str(os.getpid())+'-data.json', 'w') as outfile:
