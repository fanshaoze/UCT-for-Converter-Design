    ...
    for fn in exp:
        ...
        for vect in paramall:
           ...
           for index, value in enumerate(vect):
               a_xp,a_yp,a_Ap,a_Bp,a_Cp,a_Dp=exp_subs(a_xp,a_yp,a_Ap,a_Bp,a_Cp,a_Dp,paramname[index],str(value))
               b_xp,b_yp,b_Ap,b_Bp,b_Cp,b_Dp=exp_subs(b_xp,b_yp,b_Ap,b_Bp,b_Cp,b_Dp,paramname[index],str(value))
           ...
           VO=int(Vout[0])
           E=int(eff[0]*100)
           flag_candidate=(VO>-500) and (VO<500) and (VO<vin*0.7 or VO>vin*1.2) and E>70 and E<100
