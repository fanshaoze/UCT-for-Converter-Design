...
def key_circuit(fn,json_file):
        ...
        edge_list = json_file[fn]['list_of_edge']
...
def convert_cki(fn,pv,dn,nt):
    ...
    prefix = [      
                ...
                ".PARAM vin=%s rin=%s rout=%s cout=%su freq=%sM D=%s" % (pv[dn['Vin']],pv[dn['Rin']],pv[dn['Rout']],pv[dn['Cout']],pv[dn['Frequency']],pv[dn['Duty_Cycle']]),
                "\n",
                "*input*",
                "Vclock1 gate_a 0 PULSE (0 {vin} 0 0.1n 0.1n %su %su)" %(1/pv[dn['Frequency']]*pv[dn['Duty_Cycle']],1/pv[dn['Frequency']]),
                "Vclock2 gate_b 0 PULSE ({vin} 0 0 0.1n 0.1n %su %su)" %(1/pv[dn['Frequency']]*pv[dn['Duty_Cycle']],1/pv[dn['Frequency']]),
