...
def random_search(traj_list, configs, date_str, target_vout_min=-500, target_vout_max=500):
                ...
                for i in range(len(simu_results)):
                    if simu_results[i][0] == data_fn:
                        ...
                        while i < (len(simu_results)) and simu_results[i][0] == data_fn:
                            ...
                            tmp_reward = TopoPlanner.calculate_reward(effis, configs["target_vout"], configs['min_vout'],
                                                          configs['max_vout'])
