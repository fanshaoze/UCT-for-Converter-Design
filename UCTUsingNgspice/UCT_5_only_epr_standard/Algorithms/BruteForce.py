...
def brute_force(depth_list, trajectory, configs, date_str):
    ...
    simulation_folder = "simu_analy/" + date_str + '-' + str(os.getpid()) + "/" + str(trajectory[0])
    mkdir(figure_folder)
    ...
    for Traj in trajectory:
        ...
        for _ in range(Traj):
            ...
            # simulate_one_analytics_result(results_tmp)
            ...
            # if final_result > 0.8:
            #     print('find good using:', sim.query_counter)
            #     return
        ...
        for i in range(len(sim.topk)):
            ...
            if current.graph_is_valid():
                ...
                results_tmp = get_analytics_file(key_expression, current.graph,
                                                 ...
                                                 [sim.topk[i][2]], sim.configs_['min_vout'])
            else:
                results_tmp = None
